...
expName = 'Visual Search PsychoPy'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kanis\\Desktop\\Lab in Psychology\\Task 3\\Visual Search PsychoPy.py',
...
trialComponents = [Fixation, Target, Distractor]
